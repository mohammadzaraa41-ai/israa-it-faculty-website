...
const Prospective = () => {
  ...
  const handleRegister = async (e) => {
    ...
    const yearSemLabel = lang === 'ar' ? `سنة ${regForm.year} - فصل ${regForm.semester}` : `Year ${regForm.year} - Sem ${regForm.semester}`;
        ...
        {selectedMajor && (
          <div className="login-modal-overlay major-details-overlay" onClick={() => setSelectedMajor(null)} style={{zIndex: 5000}}>
            ...
            >
              ...
              <div style={{ background: 'var(--surface-color)', padding: '1.5rem', borderRadius: '12px', border: '1px solid var(--surface-border)', marginBottom: '1.5rem' }}>
