export const curriculumData = {
  ar: {
    specializations: [
      ...
      { 
        ...
        description: 'تصميم وبناء أنظمة برمجية ضخمة وموثوقة بجودة عالمية (بكالوريوس وماجستير).',
        advice: 'نصيحة الموجه: الكلية من أوائل الكليات في الأردن التي طرحت ماجستير هندسة البرمجيات. المهندس لا يكتب الكود فقط، بل يصممه. تعلم أنماط التصميم وكيفية العمل ضمن فريق، فالأنظمة الضخمة تُبنى بالتعاون.',
        icon: 'Cpu',
        logicKeywords: ['هندسة', 'نظام', 'مشروع', 'software engineering', 'ماجستير'] 
      },
      { 
        id: 'sec', 
    ...
    courses: {
      cs: [
        { id: 1, name: 'منهجية البرمجيات', credits: 3 },
        { id: 2, name: 'هياكل البيانات', credits: 3 },
        { id: 3, name: 'خوارزميات', credits: 3 },
        { id: 12, name: 'تحليل وتصميم النظم', credits: 3 },
        { id: 13, name: 'قواعد البيانات', credits: 3 }
      ],
      cs_net: [
        { id: 4, name: 'شبكات حاسوب متقدمة', credits: 3 },
        { id: 5, name: 'بروتوكولات الانترنت المتقدمة', credits: 3 },
        { id: 20, name: 'إدارة الشبكات', credits: 3 }
      ],
      cs_multi: [
        { id: 6, name: 'أنظمة وسائط متعددة', credits: 3 },
        { id: 7, name: 'الرسوم المتحركة ثنائية الأبعاد', credits: 3 },
        { id: 21, name: 'إنتاج صوت وصورة', credits: 3 }
      ],
      se: [
        { id: 8, name: 'أساسيات هندسة البرمجيات', credits: 3 },
        { id: 9, name: 'هندسة متطلبات البرمجيات', credits: 3 },
        { id: 22, name: 'إدارة مشاريع البرمجيات', credits: 3 },
        { id: 23, name: 'جودة البرمجيات', credits: 3 }
      ],
      sec: [
        { id: 10, name: 'أمنية الشبكات', credits: 3 },
        { id: 11, name: 'التحقيقات وتحليل الأدلة الجنائية', credits: 3 },
        { id: 24, name: 'الاختراق الأخلاقي', credits: 3 }
      ],
      cyber: [
        { id: 16, name: 'مقدمة في أمن المعلومات', credits: 3 },
        { id: 17, name: 'بروتوكولات أمن المعلومات', credits: 3 },
        { id: 25, name: 'أمن الحوسبة السحابية', credits: 3 }
      ],
      cis: [
        { id: 12, name: 'إدارة نظم قواعد البيانات', credits: 3 },
        { id: 13, name: 'مستودعات البيانات', credits: 3 },
        { id: 26, name: 'تنقيب البيانات', credits: 3 }
      ],
      ds_ai: [
        { id: 14, name: 'أساسيات تعلم الآلة', credits: 3 },
        { id: 15, name: 'علم البيانات', credits: 3 },
        { id: 27, name: 'البرمجة بلغة بايثون', credits: 3 },
        { id: 28, name: 'الروبوتات', credits: 3 }
      ]
    },
    generalResponses: {
      greeting: "مرحباً بك! أنا مستشارك الأكاديمي في الكلية. كيف يمكنني مساعدتك اليوم؟",
  ...
  en: {
    ...
    generalResponses: {
      greeting: "Hello! I am your Academic Advisor. How can I assist you today?",
