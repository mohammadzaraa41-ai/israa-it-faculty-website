...
export const DB_SCHEMA = {
  ...
  facultyMembers: [
    { 
      ...
      departmentId: "cs",
      role: 'العميد', 
      specialization: 'الذكاء الاصطناعي وعلوم الحاسوب', 
      office: 'مكتب عميد الكلية - الطابق الثاني', 
    ...
    { 
      ...
      name: 'د. سارة عيسى', 
      departmentId: "se",
      role: 'رئيس قسم هندسة البرمجيات', 
      specialization: 'هندسة البرمجيات وجودة الأنظمة', 
      office: 'مكتب 304 - الطابق الثالث', 
      officeHours: 'الاثنين والأربعاء (09:00 - 11:00)' 
    },
    { 
      id: 3,
      name: 'د. عمرو الشواورة', 
      departmentId: "cs",
      role: 'دكتور', 
      specialization: 'نظم المعلومات والخوارزميات', 
      office: 'مكتب 205 - الطابق الثاني', 
      officeHours: 'الاثنين والأربعاء (11:00 - 01:00)' 
    }
  ],
